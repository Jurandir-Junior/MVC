...
namespace McBonaldsMVC.Repositories
{
    public class PedidoRepository : RepositoryBase
    {
        ...
        private string PrepararRegistroCSV(Pedido pedido)
        {
            ...
            return $"cliente_nome={cliente.Nome}; cliente_endereço= {cliente.Endereco}; cliente_telefone= {cliente.Telefone}; cliente_email={cliente.Email}; hamburguer_nome= {hamburguer.Nome}; hambuguer_preço= {hamburguer.Preco}; shake_nome= {shake.Nome}; shake_preço= {shake.Preco}; data_pedido= {pedido.DataDoPedido}; preco_total = {pedido.PrecoTotal}";
        }
    }
}